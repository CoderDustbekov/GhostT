#!/usr/bin/python
# << CODE BY DUSTBEKOV
# << MUALLIF HUQUQLARI HIMOYA QILANDI KODNI EDIT QILISH VA O'Z NOMIDAN TARQATISH MUALLIFLIK HUQUQLARINI BUZGAN HISOBLANADI! 
...
Bl = '\033[30m'  # Kod t.me/Mr_Dustbekov tomonidan yozildi! 
Re = '\033[1;31m'
Gr = '\033[1;32m'
Ye = '\033[1;33m'
Blu = '\033[1;34m'
...
def phoneGW():
    User_phone = input(
        f"\n {Wh}Enter phone number target {Gr}Ex [+998xxxxxxxxx] {Wh}: {Gr}")  # INPUT NUMBER PHONE
    default_region = "ID"  # DEFAULT UZBEKISTAN
